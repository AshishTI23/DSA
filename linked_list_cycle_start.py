# Given a linked list determine if it has cycle in it find starting point of cycle.
...
linked_list.push_at_begining(10)
linked_list.push_at_begining(6)

# creating loop
linked_list.head.next.next.next = linked_list.head.next


print(linked_list.loop_start().val)
